...
import com.ashish.cinemahub.databinding.ActivityAllBinding
...
class AllActivity : AppCompatActivity() {
    ...
    private var listofMovie = ArrayList<com.ashish.cinemahub.data.models.movies.Result>()
    private var listofTv = ArrayList<com.ashish.cinemahub.data.models.tvs.Result>()
    var currentItems = 0
    var totalItems = 0
